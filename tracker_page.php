<html><head><link rel="stylesheet" href="style.css" type="text/css" /><title>lame!</title></head><body bgcolor="#DDDDDD">
		...
		<td colspan="3" valign="bottom" class="serverName"><span class="color7"></span><span class="color1">Sen</span><span class="color3">sory </span><span class="color5">Sys</span><span class="color4">tems</span></td></tr>
		...
		<td width="116"><table cellspacing="0" cellpadding="0" class="players" border="0"><tr height="5"><td></td></tr><tr><td>Players: 5/16</td></tr></table></td>
		...
		<style>.ls1{background: url("images/levelshots/mp_ffa4_1.jpg");}
.ls2{background: url("images/levelshots/mp_ffa4_2.jpg");}
.ls3{background: url("images/levelshots/mp_ffa4_3.jpg");}
		...
		<td width="106">Map: <span class="color7">mp/ffa4</span></td></tr>
		<tr height="15"><td colspan="2">Mod Name: JA+ Mod v2.4 beta6</td></tr>
		<tr height="15"><td colspan="2"><table class="info" cellpadding="0" cellspacing="0" border="0"><tr><td>Server IP: 74.232.117.198:29070</td><td width="6" background="images/tracker/blinker.gif"></td></tr></table></td></tr>
</table></td></tr></table></td></tr></table></body></html>
		<script language="javascript" type="text/javascript"><!-- 
		fadels();
		//--></script><img src="images/levelshots/mp_ffa4_1.jpg" class="hiddenPic"><img src="images/levelshots/mp_ffa4_2.jpg" class="hiddenPic"><img src="images/levelshots/mp_ffa4_3.jpg" class="hiddenPic"><img src="images/tracker/param.gif" class="hiddenPic" /><img src="images/tracker/param_c.gif" class="hiddenPic" /><img src="images/tracker/param_l.gif" class="hiddenPic" /><img src="images/tracker/rcon.gif" class="hiddenPic" /><img src="images/tracker/rcon_c.gif" class="hiddenPic" /><img src="images/tracker/rcon_l.gif" class="hiddenPic" />